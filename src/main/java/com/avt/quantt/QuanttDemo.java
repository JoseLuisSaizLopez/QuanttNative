    ...
    public void start(Stage stage) {
        ...
        QuanttNative qNative = new QuanttNative(
                ...
                new QuanttNative.QParams()
                        ...
                        .add(QuanttNative.ParamKey.TITLEBAR_BACKGROUND_COLOR, new Color(0x494970))
        ...
        //Add title properties embedded inside scene
        qNative.addTitleProperties(qNative.getScene().lookup("#titlebar"));
        qNative.addTitleProperties(qNative.getScene().lookup("#tabpane"));
    }
